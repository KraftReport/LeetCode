...
import program.code.KeepsMultiplyingFoundValuesByTwo;
import program.code.MakeTwoArraysEqualsByReversingSubArrays;
import program.code.MaxFrequencyElements;
import program.code.MaximizeAtMostSumOfKDistinctElements;
...
import program.code.UncommonWordsFromTwoSentences;
import program.code.UniqueNumberOfOccurences;

public class Main {

	public static void main(String[] args) {
//		System.out.println(MaxFrequencyElements.solution(new int[] {1,2,2,3,1,4}));
...
//		for(var data : UncommonWordsFromTwoSentences.solution("apple apple", "banana")) {
//			System.out.println(data);
//		}
//		for(var data : MaximizeAtMostSumOfKDistinctElements.solution(new int[]  {1,1,1,2,2,2}, 6)) {
//			System.out.println(data);
//		}
		System.out.println(KeepsMultiplyingFoundValuesByTwo.solution(new int[] {2,7,9}, 4));
	}
}
